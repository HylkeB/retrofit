...
abstract class BuiltInParameterHandlers<T> implements ParameterHandler<T> {
  ...
  final ParameterHandler<Iterable<T>> iterable() {
    return new ParameterHandler<Iterable<T>>() {
      ...
      public void apply(RequestBuilder builder, @Nullable Iterable<T> values) throws IOException {
        ...
        for (T value : values) {
          BuiltInParameterHandlers.this.apply(builder, value);
        }
      }
    };
  }
    ...
    return new ParameterHandler<Object>() {
      ...
      public void apply(RequestBuilder builder, @Nullable Object values) throws IOException {
        ...
        for (int i = 0, size = Array.getLength(values); i < size; i++) {
          ...
          BuiltInParameterHandlers.this.apply(builder, (T) Array.get(values, i));
        }
      }
    };
  }

  static final class RelativeUrl extends BuiltInParameterHandlers<Object> {
  ...
  static final class Header<T> extends BuiltInParameterHandlers<T> {
  ...
  static final class Path<T> extends BuiltInParameterHandlers<T> {
    private final Method method;
    private final int p;
    private final String name;
    private final Converter<T, String> valueConverter;
  ...
  static final class Query<T> extends BuiltInParameterHandlers<T> {
    private final String name;
    private final Converter<T, String> valueConverter;
    private final boolean encoded;
  ...
  static final class QueryName<T> extends BuiltInParameterHandlers<T> {
  ...
  static final class QueryMap<T> extends BuiltInParameterHandlers<Map<String, T>> {
    private final Method method;
    private final int p;
    private final Converter<T, String> valueConverter;
    private final boolean encoded;
  ...
  static final class HeaderMap<T> extends BuiltInParameterHandlers<Map<String, T>> {
    private final Method method;
    private final int p;
    private final Converter<T, String> valueConverter;
  ...
  static final class Headers extends BuiltInParameterHandlers<okhttp3.Headers> {
    private final Method method;
    private final int p;
  ...
  static final class Field<T> extends BuiltInParameterHandlers<T> {
    private final String name;
    private final Converter<T, String> valueConverter;
    private final boolean encoded;
  ...
  static final class FieldMap<T> extends BuiltInParameterHandlers<Map<String, T>> {
    private final Method method;
    private final int p;
    private final Converter<T, String> valueConverter;
    private final boolean encoded;
  ...
  static final class Part<T> extends BuiltInParameterHandlers<T> {
    private final Method method;
    private final int p;
  ...
  static final class RawPart extends BuiltInParameterHandlers<MultipartBody.Part> {
  ...
  static final class PartMap<T> extends BuiltInParameterHandlers<Map<String, T>> {
    private final Method method;
    private final int p;
  ...
  static final class Body<T> extends BuiltInParameterHandlers<T> {
    private final Method method;
    private final int p;
    private final Converter<T, RequestBody> converter;
  ...
  static final class Tag<T> extends BuiltInParameterHandlers<T> {
    final Class<T> cls;
